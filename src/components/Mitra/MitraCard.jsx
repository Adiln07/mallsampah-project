...
import Card1 from "../../assets/Image/Mitra/Card1.jpg";

const MitraCard = ({title, deskripsi, image}) => {
  return (
    <div
      className=" m-auto lg:w-[50em] lg:h-[20em] md:w-[45em] md:h-[15em] w-[20em] h-[25em] bg-cover rounded-2xl my-10 bg-center font-redhat group flex relative"
      style={{
        backgroundImage: `url('${image}')`,
      }}
    >
        <h1 className="text-4xl text-white font-bold pt-3 pl-5 ">{title}</h1>
