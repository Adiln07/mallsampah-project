        ...
        <nav className=" flex lg:justify-center justify-between items-center gap-48 W-[92%] py-4  ">
          ...
          >
            <ul className="flex lg:flex-row flex-col lg:items-center  lg:gap-[4vw] gap-10">
              <li>
                <a href="/TentangKami" className=" font-semibold hover:text-[#28AF5D]">
                  Tentang Kami
                </a>
              </li>
              <li className="group">
              ...
              <li>
                <a className=" font-semibold hover:text-[#28AF5D]" href="/Mitra">
                  Mitra
                </a>
              </li>
              <li>
                <a className=" font-semibold hover:text-[#28AF5D]" href="#">
                  Berita
                </a>
              </li>
              <li>
