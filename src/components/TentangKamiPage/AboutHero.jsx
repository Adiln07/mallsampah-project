import About from "../../assets/Image/TentangKami/About.jpg";
      ...
      >
        ...
        <div className=" xl:w-[32em] lg:w-[25em] md:w-[40em] w-[20em]">
          <div className="flex items-center gap-4 pb-3">
            ...
            <h1 className="xl:text-5xl lg:text-2xl text-3xl font-bold ">Tentang Kami</h1>
          </div>
          <h1 className="xl:text-3xl lg:text-xl md:text-2xl font-semibold text-xl">We Are The Recycling Network</h1>
